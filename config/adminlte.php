...
return [
    ...
    */
    ...
    |
    | Para obtener instrucciones detalladas, puede consultar la sección de filtros de menú aquí:
    | https://github.com/jeroennoten/Laravel-AdminLTE/wiki/8.-Menu-Configuration
    |
    */
    ...
    */
    ...
    |
    | Para obtener instrucciones detalladas, puede mirar el livewire aquí:
    | https://github.com/jeroennoten/Laravel-AdminLTE/wiki/9.-Other-Configuration
    */
